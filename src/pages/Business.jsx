...
export default function BusinessPosts({ category = "business", user }) {
  ...
  const fetchBusiness = async () => {
    ...
    try {
      ...
      console.error("Failed to fetch business articles:", err);
      setError(err.message || "Failed to load business articles.");
    } finally {
      setLoading(false);
    }
  };
  ...
  if (error) return <ErrorMessage message={error} onRetry={fetchBusiness} />;
